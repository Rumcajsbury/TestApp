...
namespace eShopOnWeb.UITests.PagesModels
{
    public class ChangePasswordPage
    {
        ...
        private IWebElement UpdateBtn => _driver.FindElement(By.ClassName("btn btn-default"));
        ...
        {
            var items = _driver.FindElement(By.ClassName("text-danger validation-summary-errors")).FindElement(By.TagName("ul"))
